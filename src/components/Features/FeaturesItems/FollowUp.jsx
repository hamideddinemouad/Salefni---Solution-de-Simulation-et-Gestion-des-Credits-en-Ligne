export default function FollowUp() {
  return (
    <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 hover:shadow-lg hover:-translate-y-2 transition-all">
      ...
      <h3 className="text-xl font-bold text-primary-main mb-2">Suivi Simple</h3>
      <p className="text-gray-600 leading-relaxed">
        Soumettez votre demande en ligne et recevez une confirmation immédiate.
        Suivez son statut facilement.
      </p>
    </div>
  );
}
